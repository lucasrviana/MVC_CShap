...
namespace DevIO.App.Extensions
{
    ...
    {
        private IValidationAttributeAdapterProvider _BaseOProvider = new ValidationAttributeAdapterProvider(); 
        public IAttributeAdapter GetAttributeAdapter(ValidationAttribute attribute, IStringLocalizer stringLocalizer)
        {
            if (attribute is MoedaAttribute moeda)
                return new MoedaAttributeAdapter(moeda, stringLocalizer);

            return _BaseOProvider.GetAttributeAdapter(attribute, stringLocalizer);
